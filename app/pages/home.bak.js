...
export default class home extends Component {
    ...
    getQuestionShowList = () => {
        ...
        end = (end > this.state.tagQuestionList.length - 1) ? this.state.tagQuestionList.length - 1 : end
        var temp = this.state.tagQuestionList.slice(start, end)
        this.setState({
    ...
    nextPage = () => {
        ...
        if (end < this.state.tagQuestionList.length - 1) {
            this.state.pageIndex++
            this.getQuestionShowList()
        }
    }
    ...
    getSortFunction = () => {
        switch (this.state.sortType) {
            ...
            case 2:
                return function (a, b) {
                    return parseInt(a.originQuestion.difficulty.level) - parseInt(b.originQuestion.difficulty.level) || a.oldIndex - b.oldIndex
                };
            case 3:
                return function (a, b) {
                    return parseInt(b.originQuestion.difficulty.level) - parseInt(a.originQuestion.difficulty.level) || a.oldIndex - b.oldIndex
                };
            default:
                return function (a, b) {
    ...
    idSort = () => {
        ...
        this.state.tagQuestionList.sort(this.getSortFunction())
                    ...
                    <TouchableHighlight
                        ...
                        <View style={styles.item}>
                            <View style={styles.item_text}>
                                <Text style={styles.title}>  {item.question.questionId}. {item.title}</Text>
